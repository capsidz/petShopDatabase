...
##### 1. Создайте коллекцию articles с векторами размерности 384
```
...
articles_data = [
    {"title": "Новый процессор от Intel", "content": "Архитектура и тесты производительности нового чипа.", "author": "Иванов", "category": "tech", "published_at": "2024-02-15T12:00:00Z", "views": 1500, "rating": 4.5},
    {"title": "Как начать бегать по утрам", "content": "Советы для новичков: правильная обувь, техника бега и разминка.", "author": "Петров", "category": "sport", "published_at": "2023-11-10T08:30:00Z", "views": 2500, "rating": 4.8},
    {"title": "Итоги чемпионата мира", "content": "Обзор финального матча и статистика игроков.", "author": "Сидоров", "category": "sport", "published_at": "2024-03-01T21:00:00Z", "views": 5000, "rating": 3.9},
    {"title": "Революция в AI: GPT-5", "content": "Обсуждение будущих возможностей больших языковых моделей.", "author": "Иванов", "category": "tech", "published_at": "2024-05-20T10:15:00Z", "views": 8000, "rating": 4.9},
    {"title": "Смартфоны будущего", "content": "Гибкие экраны и новые аккумуляторы изменят индустрию.", "author": "Смирнов", "category": "tech", "published_at": "2023-05-12T14:00:00Z", "views": 1200, "rating": 3.2},
    {"title": "Главные новости недели", "content": "Коротко о важных событиях в мире политики и экономики.", "author": "Васильев", "category": "news", "published_at": "2024-06-01T09:00:00Z", "views": 300, "rating": 4.0},
    {"title": "Спортивное питание", "content": "Что нужно есть до и после тренировок для максимального результата.", "author": "Петров", "category": "sport", "published_at": "2024-01-10T16:45:00Z", "views": 600, "rating": 3.7},
]
...
##### Вывод:
```
=== Простой поиск ('бег и спорт') ===
[0.623] Смартфоны будущего | Кат: tech | Рейтинг: 3.2 | Просмотры: 1200
[0.597] Итоги чемпионата мира | Кат: sport | Рейтинг: 3.9 | Просмотры: 5000
[0.567] Спортивное питание | Кат: sport | Рейтинг: 3.7 | Просмотры: 600

=== Tech статьи с рейтингом >= 4.0 ===
[0.578] Новый процессор от Intel | Кат: tech | Рейтинг: 4.5 | Просмотры: 1500
[0.491] Революция в AI: GPT-5 | Кат: tech | Рейтинг: 4.9 | Просмотры: 8000

=== Опубликовано после 2024-01-01 и просмотры > 1000 ===
[0.573] Итоги чемпионата мира | Кат: sport | Рейтинг: 3.9 | Просмотры: 5000
[0.522] Революция в AI: GPT-5 | Кат: tech | Рейтинг: 4.9 | Просмотры: 8000
[0.518] Новый процессор от Intel | Кат: tech | Рейтинг: 4.5 | Просмотры: 1500

=== Сложный фильтр (sport/tech, рейтинг >= 3.5, просмотры 500-5000) ===
[0.704] Спортивное питание | Кат: sport | Рейтинг: 3.7 | Просмотры: 600
[0.640] Итоги чемпионата мира | Кат: sport | Рейтинг: 3.9 | Просмотры: 5000
[0.578] Как начать бегать по утрам | Кат: sport | Рейтинг: 4.8 | Просмотры: 2500
[0.554] Новый процессор от Intel | Кат: tech | Рейтинг: 4.5 | Просмотры: 1500
```
...
# Демонстрация работы пагинации по запросу "технологии"
...
Позиция 1: Смартфоны будущего (Score: 0.558)
Позиция 2: Главные новости недели (Score: 0.521)

--- Пагинация: Страница 2 (размер 2) ---
Позиция 3: Новый процессор от Intel (Score: 0.482)
Позиция 4: Революция в AI: GPT-5 (Score: 0.463)
```